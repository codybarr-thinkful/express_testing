...
app.get('/sum', (req, res) => {
	...
	if (!a) {
		return res.status(400).json({ error: 'Value for a is needed' })
	}

	if (!b) {
		return res.status(400).json({ error: 'Value for b is needed' })
	}
...
// Calculate the midpoint of two lat/lon coords
